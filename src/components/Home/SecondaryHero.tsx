      ...
      <div className="container relative">
        ...
        >
          ...
          >
            ...
            <motion.h1
              variants={itemVariants}
              className="mb-6 text-3xl sm:text-4xl text-center lg:text-left font-bold text-foreground md:text-5xl leading-[1.2]"
            >
              {heroData.title}
            </motion.h1>
            ...
            <motion.p
              variants={itemVariants}
              className="mb-8 text-sm text-center lg:text-left sm:text-base text-foreground/80 max-w-xl font-poppins font-light lg:font-normal"
            >
            ...
            <motion.div
              variants={itemVariants}
              className="mt-12 grid grid-cols-3 gap-4 sm:gap-12 justify-center items-center"
            >
