...
const teamMembers: TeamMember[] = [
    {
        ...
        image: 'https://base.demo.nextjstemplates.com/_next/image?url=%2Fimages%2Fteam%2Fteam-01.png&w=384&q=75',
    },
    {
        name: 'Eva Hudson',
        role: 'Product Designer',
        image: 'https://base.demo.nextjstemplates.com/_next/image?url=%2Fimages%2Fteam%2Fteam-02.png&w=384&q=75',
    },
    {
        name: 'Jackie Sanders',
        role: 'Web Designer',
        image: 'https://base.demo.nextjstemplates.com/_next/image?url=%2Fimages%2Fteam%2Fteam-03.png&w=384&q=75',
    },
];
...
const MeetOurTeam: React.FC = () => {
    return (
        <section
            id="team"
            className="relative z-1 overflow-hidden py-20 lg:py-24 xl:py-32"
        >
            {/* Background Elements */}
            ...
            {/* Header Section */}
            <div className="animate-slide-up relative z-10 mx-auto max-w-7xl px-4 text-center md:px-8 xl:px-0">
            ...
            {/* Team Members Grid */}
            <div className="relative z-10 mx-auto mt-12 max-w-7xl px-4 md:px-8 lg:mt-16 xl:px-24">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-12">
                    {teamMembers.map((member, index) => (
                        <div key={index} className="animate-slide-up text-center">
                            <div className="group relative z-1 overflow-hidden rounded-lg">
                                <Image
                                    src={member.image}
                                    alt={member.name}
                                    width={360}
                                ...
                                <div className="translate-y-25 duration-300 ease-linear group-hover:translate-y-0">
                                    <span className="absolute -bottom-20 -left-5 z-20 block h-[150px] w-[120%] rotate-6 bg-primary"></span>
                                    <span className="absolute bottom-0 left-0 z-10 block h-[68px] w-full bg-secondary"></span>
                                    <div className="absolute bottom-0 left-0 z-30 w-full pb-5 pt-7">
                            ...
                            <h4 className="mb-1 mt-7 text-xl font-medium text-foreground md:text-2xl">
                                {member.name}
                            </h4>
