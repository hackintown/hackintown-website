      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-5">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="relative bg-background p-6 rounded-3xl overflow-hidden shadow-sm border border-border flex flex-col
            ...
            >
              ...
              <p className="text-base lg:text-lg font-bold text-foreground relative z-20">
                {feature.title}
              </p>
