    ...
    const NavigationButton = ({
        ...
        <button
            ...
            className={`
                ...
                ${disabled || isTransitioning ? 'opacity-50 cursor-not-allowed' : 'hover:translate-y-[-2px]'}
                ${direction === 'prev'
            ...
            <div className="container max-w-7xl mx-auto">
                <div className="text-center mb-8">
                    ...
                    <p className="text-muted-foreground text-sm sm:text-base font-light max-w-2xl mx-auto">
                        Find answers to common questions about our IT services, support options, and solutions
                    </p>
                </div>
                    ...
                    {steps.map((step, index) => (
                        <button
                            ...
                            className={`
                                ...
                                ${isTransitioning ? 'cursor-not-allowed' : 'hover:scale-105'}
                ...
                >
                    ...
                    <div className="space-y-4">
                        {currentStep.questions.map((q) => (
                            <div key={q.id} className="rounded-lg overflow-hidden border border-border shadow-sm">
                                <button
                                ...
                                >
                                    ...
                                    <motion.div
                                        animate={{ rotate: expandedQuestions.includes(q.id) ? 90 : 0 }}
            ...
            <div className="fixed bottom-6 right-6 z-50">
                <button
                    ...
                    className={`
                        ...
                        ${isChatbotOpen ? 'bg-destructive text-destructive-foreground rotate-90' : 'bg-primary text-primary-foreground hover:bg-primary/90'}
                    `}
